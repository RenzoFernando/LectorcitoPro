...
- **Windows — Instalable:** `LectorcitoPro-Setup.exe`
    ...
    Opción recomendada para uso habitual en Windows. El instalador empaqueta un build propio de la aplicación, independiente del Portable, con una estructura convencional y una instalación por usuario que funciona con permisos normales. No modifica Microsoft Defender ni utiliza autofirma local.

- **Windows — Portable:** `LectorcitoPro-Portable.exe`

    Ejecutable independiente que puede utilizarse directamente sin instalación y con permisos normales. No modifica la configuración de seguridad del sistema.
...
- [`docs/compilation.md`](docs/compilation.md) — calidad, dependencias, compilación, builds y proceso de release.
