...
1. Implementado escalado global y adaptación DPI para distintas resoluciones y configuraciones de pantalla.
2. Mejorados el encabezado, el menú principal y la distribución adaptativa de la interfaz.
3. Incorporada una arquitectura multiplataforma con servicios separados para Windows y Linux.
4. Añadido soporte funcional para Linux mediante un binario portable Onefile x86_64.
5. Profesionalizada la generación Markdown con bloques de código, navegación y tabla de contenidos.
6. Separados el escaneo, el modelo, el procesamiento y los renderizadores TXT/Markdown.
7. Reorganizado el sistema de build y release para generar y validar los tres artefactos oficiales.
8. Separadas las dependencias por runtime, plataforma, build y desarrollo, con mejoras de estabilidad.
