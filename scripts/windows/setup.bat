...
set "QUALITY_REQ=requirements\quality.txt"
...
if not exist "%QUALITY_REQ%" (

    echo ERROR: `%QUALITY_REQ%` not found. Cannot install quality dependencies.
...
"%VENV_PY%" -m pip install -r "%REQ%" -r "%BUILD_REQ%" -r "%QUALITY_REQ%" --default-timeout=100
