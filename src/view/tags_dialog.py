...
class TagsConfigDialog(BaseDialog):
    """
    Un diálogo robusto para gestionar listas de etiquetas (píldoras).
    Permite añadir, eliminar y cambiar el estado (activo/inactivo) de las etiquetas.
    Las etiquetas se reorganizan fluidamente para ajustarse al ancho de la ventana.
    """
