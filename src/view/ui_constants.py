from app_meta import APP_AUTHOR, APP_REPOSITORY_WEB_URL, APP_VERSION, get_current_year
...
MAIN_WINDOW_HEADER_MIN_HEIGHT = 82
...
MAIN_WINDOW_HEADER_TEXT_WIDTH = 320
...
# A 90 % de escala, 1 px pierde presencia visual en esquinas redondeadas.
MAIN_WINDOW_CARD_BORDER_WIDTH = BORDER_WIDTH_MEDIUM
MAIN_WINDOW_ACTION_BORDER_WIDTH = BORDER_WIDTH_MEDIUM
...
DIALOG_CARD_BORDER_WIDTH = BORDER_WIDTH_MEDIUM
...
STATUS_PANEL_BORDER_WIDTH = BORDER_WIDTH_MEDIUM
...
STATUS_PANEL_DETAILS_HEIGHT = 112
...
TAGS_DIALOG_WRAP_SAFETY_PX = 24

TAGS_DIALOG_PILL_WIDTH_SAFETY_PX = 8
