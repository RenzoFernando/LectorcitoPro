...
TRANSLATIONS = {
    "es": {
        ...
        "greet_a": [
            ...
            "¡A seguir dándole al código!",
            "La tarde es para crear.",
        ],
        "greet_n": [
            "¡Buenas noches!",
            "Un último vistazo antes de descansar.",
    ...
    "en": {
        ...
        "greet_a": [
            ...
            "Let's keep pushing that code!",
            "The afternoon is for creating.",
        ],
        "greet_n": [
            "Good evening!",
            "One last look before logging off.",
