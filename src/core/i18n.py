...
TRANSLATIONS: Dict[str, Dict[str, Any]] = {
    "es": {
        ...
        "placeholder_add_tag": "Escribir y presionar Enter para añadir...",
    ...
    "en": {
        ...
        "placeholder_add_tag": "Type and press Enter to add...",
...
class I18n:
    ...
    def tr(self, key: str, *args, lang: str | None = None):
        active_lang = lang or self.lang
        translation_entry = TRANSLATIONS.get(active_lang, TRANSLATIONS["es"]).get(key, f"<{key}>")
