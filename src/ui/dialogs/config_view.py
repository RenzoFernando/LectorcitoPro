...
class TagsConfigDialog(BaseDialog):
    def __init__(self, parent, title: str, folders_prompt: str, initial_folders: list, files_prompt: str, initial_files: list):
    ...
    def _create_tag_section(self, section_index, prompt, section_id):
        ...
        ctk.CTkLabel(self.main_frame, text=prompt, font=("Segoe UI", 12, "bold")).grid(
            row=base_row, column=0, sticky="w", pady=(15, 2)
        )
